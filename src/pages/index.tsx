  ...
  return (
    <>
      ...
      <Head>
        ...
        <meta
          name="description"
          content="Frontend Developer crafting exceptional digital experiences"
        />
      </Head>
      ...
      <div className="min-h-screen bg-white flex flex-col">
        ...
        {/* Main Content */}
        <main
          className={`flex-1 flex items-center justify-center px-6 md:px-12 pt-24 md:pt-32 pb-16`}
        >
          <div className="max-w-4xl w-full">
            <div className={`space-y-8 ${mounted ? "" : "opacity-0"}`}>
              ...
              >
                {/* Body Text: Dark Gray text */}
                <p className="text-xl md:text-2xl text-gray-700 font-normal">
              ...
              >
                {/* CTA Button: Dark gray/black on hover */}
                <Link
                  href="/contact"
