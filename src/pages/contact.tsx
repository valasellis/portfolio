...
function ContactPage() {
  ...
  return (
    <>
      <CustomCursor />
      <Head>
        {/* Specific title and description for the Contact page */}
        <title>Contact - Dimitris Valasellis</title>
        <meta
          name="description"
          content="Get in touch with Frontend Developer Dimitris Valasellis for collaborations and inquiries."
        />
      </Head>
      ...
      <div className="min-h-screen bg-white flex flex-col">
        ...
        {/* Main Content: Direct Contact CTA - Text is now left-aligned */}
        <main className="flex-1 flex items-start justify-center px-6 md:px-12 pt-24 pb-16">
          <div className="max-w-4xl w-full text-left">
            <div className={`space-y-8 ${mounted ? "" : "opacity-0"}`}>
              {/* Heading (Stagger-1): Bigger and bolder */}
              <div
                className={`${
                  textVisible ? "fade-in-up stagger-1" : "opacity-0"
                }`}
              >
              ...
              {/* Introduction (Stagger-2): Darker body text */}
              <div
                className={`${
                  textVisible ? "fade-in-up stagger-2" : "opacity-0"
                }`}
              >
                <p className="max-w-3xl text-xl md:text-2xl text-gray-700 font-normal">
                  I&apos;m currently available for freelance projects and new
                  opportunities. The best way to reach me is directly via email
                  or connect on LinkedIn.
                </p>
              </div>

              {/* Primary Contact Link (Email Button - Stagger-3): Left-aligned flex container */}
              <div
                className={`flex flex-wrap gap-4 ${
                  textVisible ? "fade-in-up stagger-3" : "opacity-0"
                }`}
              >
                <Link
                  href="mailto:valasellis.me@gmail.com"
                  className="inline-flex items-center px-8 py-3 bg-gray-900 text-white text-base font-medium rounded-full hover:bg-gray-800 transition-all duration-200 hover:shadow-lg transform hover:-translate-y-0.5"
                >
                  Send an Email
                  <svg
              ...
              {/* Social Links (Stagger-4): Left-aligned flex container */}
              <div
                className={`flex gap-6 pt-4 ${
                  textVisible ? "fade-in-up stagger-4" : "opacity-0"
                }`}
              >
                <Link
