...
function ContactPage() { // Renamed from HomePage to ContactPage for clarity
  ...
  return (
    <>
      <Head>
        ...
        <meta name="description" content="Get in touch with Frontend Developer Dimitris Valasellis for collaborations and inquiries." />
      </Head>
      ...
      <div className="min-h-screen bg-white flex flex-col">
        ...
        {/* Main Content: Direct Contact CTA */}
        <main className="flex-1 flex items-center justify-center px-6 md:px-12"> 
          <div className="max-w-4xl w-full text-center">
            <div className={`space-y-8 ${mounted ? '' : 'opacity-0'}`}>
              ...
              {/* Introduction (Stagger-2) */}
              <div className={`${textVisible ? 'fade-in-up stagger-2' : 'opacity-0'}`}>
                <p className="max-w-3xl mx-auto text-xl md:text-2xl text-gray-600 font-light">
                  I&apos;m currently available for freelance projects and new opportunities. The best way to reach me is directly via email or connect on LinkedIn.
                </p>
              </div>

              {/* Primary Contact Link (Email Button - Stagger-3) */}
              <div className={`flex flex-wrap justify-center gap-4 ${textVisible ? 'fade-in-up stagger-3' : 'opacity-0'}`}>
                <a 
              ...
              {/* Social Links (Stagger-4) */}
              <div className={`flex justify-center gap-6 pt-4 ${textVisible ? 'fade-in-up stagger-4' : 'opacity-0'}`}>
                <a 
